<x-layouts.app :title="__('Dashboard')">
    <div class="flex h-full w-full flex-1 flex-col gap-6 p-4 md:p-6 bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50 dark:from-emerald-950/40 dark:via-green-950/30 dark:to-teal-950/50 min-h-screen">
        ...
        <div class="flex flex-col gap-2 mb-2">
            ...
            <div class="h-1 w-24 bg-gradient-to-r from-emerald-400 via-green-500 to-teal-500 rounded-full"></div>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6">
            ...
            <div class="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-white/90 via-white/80 to-white/70 dark:from-emerald-900/40 dark:via-green-900/30 dark:to-teal-900/40 backdrop-blur-xl border border-emerald-100/50 dark:border-emerald-700/30 p-6 shadow-xl shadow-emerald-500/5 hover:shadow-2xl hover:shadow-emerald-500/10 transition-all duration-500 hover:-translate-y-2">
                ...
                <div class="relative z-10">
                    ...
                    <div class="mb-6">
                        <p class="text-sm font-medium text-emerald-600 dark:text-emerald-400 mb-2">Total Services</p>
                        <div class="flex items-end gap-3">
                            <p class="text-4xl md:text-5xl font-bold text-emerald-900 dark:text-white">{{ $totalServices }}</p>
                            <div class="mb-2 px-2 py-1 bg-gradient-to-r from-emerald-500/20 to-green-500/20 rounded-lg">
                                <span class="text-xs font-semibold text-emerald-700 dark:text-emerald-300">Active</span>
                            </div>
                        </div>
                    </div>
                    <a href="{{ route('admin.services.index') }}" class="inline-flex items-center gap-2 text-sm font-semibold text-emerald-700 dark:text-emerald-300 hover:text-emerald-900 dark:hover:text-white transition-colors group/link">
                        <span>View Services</span>
                        <div class="w-8 h-8 rounded-full bg-gradient-to-r from-emerald-500/10 to-teal-500/10 flex items-center justify-center group-hover/link:bg-emerald-500/20 transition-all">
            ...
            @else
            <div class="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-white/80 to-emerald-50/80 dark:from-emerald-900/30 dark:to-teal-900/20 backdrop-blur-xl border-2 border-dashed border-emerald-200 dark:border-emerald-700/30 p-8 flex flex-col items-center justify-center text-center hover:border-emerald-300 dark:hover:border-emerald-600 transition-all duration-500 hover:shadow-lg hover:shadow-emerald-500/10">
                <div class="p-4 rounded-2xl bg-gradient-to-r from-emerald-400/10 via-green-500/10 to-teal-500/10 mb-4">
                ...
                <p class="text-sm font-medium text-emerald-700 dark:text-emerald-300 mb-2">Add Services Data</p>
                <p class="text-xs text-emerald-500/70 dark:text-emerald-400/70">Start by adding your first service</p>
            </div>
            @endisset
            ...
            <div class="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-white/90 via-white/80 to-white/70 dark:from-emerald-900/40 dark:via-green-900/30 dark:to-teal-900/40 backdrop-blur-xl border border-emerald-100/50 dark:border-emerald-700/30 p-6 shadow-xl shadow-emerald-500/5 hover:shadow-2xl hover:shadow-emerald-500/10 transition-all duration-500 hover:-translate-y-2">
                ...
                <div class="relative z-10">
                    ...
                    <div class="mb-6">
                        <p class="text-sm font-medium text-emerald-600 dark:text-emerald-400 mb-2">Total Galleries</p>
                        <div class="flex items-end gap-3">
                            <p class="text-4xl md:text-5xl font-bold text-emerald-900 dark:text-white">{{ $totalGalleries }}</p>
                            <div class="mb-2 px-2 py-1 bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-lg">
                                <span class="text-xs font-semibold text-emerald-700 dark:text-emerald-300">Media</span>
                            </div>
                        </div>
                    </div>
                    <a href="{{ route('admin.galleries.index') }}" class="inline-flex items-center gap-2 text-sm font-semibold text-emerald-700 dark:text-emerald-300 hover:text-emerald-900 dark:hover:text-white transition-colors group/link">
            ...
            <div class="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-white/80 to-emerald-50/80 dark:from-emerald-900/30 dark:to-teal-900/20 backdrop-blur-xl border-2 border-dashed border-emerald-200 dark:border-emerald-700/30 p-8 flex flex-col items-center justify-center text-center hover:border-emerald-300 dark:hover:border-emerald-600 transition-all duration-500 hover:shadow-lg hover:shadow-emerald-500/10">
                ...
                <p class="text-sm font-medium text-emerald-700 dark:text-emerald-300 mb-2">Add Galleries Data</p>
                <p class="text-xs text-emerald-500/70 dark:text-emerald-400/70">Showcase your visual content</p>
            </div>
            @endisset
            ...
            <div class="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-white/90 via-white/80 to-white/70 dark:from-emerald-900/40 dark:via-green-900/30 dark:to-teal-900/40 backdrop-blur-xl border border-emerald-100/50 dark:border-emerald-700/30 p-6 shadow-xl shadow-emerald-500/5 hover:shadow-2xl hover:shadow-emerald-500/10 transition-all duration-500 hover:-translate-y-2">
                ...
                <div class="relative z-10">
                    ...
                    <div class="mb-6">
                        <p class="text-sm font-medium text-emerald-600 dark:text-emerald-400 mb-2">Total Products</p>
                        <div class="flex items-end gap-3">
                            <p class="text-4xl md:text-5xl font-bold text-emerald-900 dark:text-white">{{ $totalProducts }}</p>
                            <div class="mb-2 px-2 py-1 bg-gradient-to-r from-teal-500/20 to-emerald-500/20 rounded-lg">
                                <span class="text-xs font-semibold text-emerald-700 dark:text-emerald-300">Items</span>
                            </div>
                        </div>
                    </div>
                    <a href="{{ route('admin.products.index') }}" class="inline-flex items-center gap-2 text-sm font-semibold text-emerald-700 dark:text-emerald-300 hover:text-emerald-900 dark:hover:text-white transition-colors group/link">
            ...
            <div class="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-white/80 to-emerald-50/80 dark:from-emerald-900/30 dark:to-teal-900/20 backdrop-blur-xl border-2 border-dashed border-emerald-200 dark:border-emerald-700/30 p-8 flex flex-col items-center justify-center text-center hover:border-emerald-300 dark:hover:border-emerald-600 transition-all duration-500 hover:shadow-lg hover:shadow-emerald-500/10">
                ...
                <p class="text-sm font-medium text-emerald-700 dark:text-emerald-300 mb-2">Add Products Data</p>
                <p class="text-xs text-emerald-500/70 dark:text-emerald-400/70">Expand your product catalog</p>
            </div>
            @endisset
        </div>
        ...
        <div class="rounded-2xl bg-gradient-to-br from-white/90 via-white/80 to-white/70 dark:from-emerald-900/40 dark:via-green-900/30 dark:to-teal-900/40 backdrop-blur-xl border border-emerald-100/50 dark:border-emerald-700/30 overflow-hidden transition-all duration-500 hover:shadow-2xl hover:shadow-emerald-500/10">
            ...
            <div class="bg-gradient-to-r from-emerald-500/5 via-green-500/5 to-teal-500/5 border-b border-emerald-100/50 dark:border-emerald-700/30 p-6">
                <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h3 class="text-2xl font-bold text-emerald-900 dark:text-white">Latest Products</h3>
                            <p class="text-emerald-600 dark:text-emerald-300">Recently added products in your catalog</p>
                        </div>
                    </div>
                    <div class="flex flex-wrap gap-3">
                        <a href="{{ route('admin.products.create') }}" class="group/btn px-5 py-3 bg-gradient-to-r from-emerald-500 to-teal-500 text-white rounded-xl hover:from-emerald-600 hover:to-teal-600 transition-all duration-300 shadow-lg shadow-emerald-500/30 hover:shadow-xl hover:shadow-emerald-500/40 flex items-center gap-2 font-semibold">
                        ...
                        <a href="{{ route('admin.products.index') }}" class="px-5 py-3 border border-emerald-200 dark:border-emerald-700 text-emerald-700 dark:text-emerald-300 rounded-xl hover:bg-emerald-500/10 dark:hover:bg-emerald-500/10 transition-all duration-300 flex items-center gap-2 font-semibold">
                            View All
            ...
            <div class="p-6">
                ...
                <div class="text-center py-12">
                    <div class="inline-flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-r from-emerald-500/10 to-teal-500/10 mb-6">
                    ...
                    <h4 class="text-xl font-bold text-emerald-900 dark:text-white mb-3">No products yet</h4>
                    <p class="text-emerald-600 dark:text-emerald-400 mb-8 max-w-md mx-auto">Start by adding your first product to showcase in your store.</p>
                    <a href="{{ route('admin.products.create') }}" class="inline-flex items-center gap-3 px-6 py-3.5 bg-gradient-to-r from-emerald-500 to-teal-500 text-white rounded-xl hover:from-emerald-600 hover:to-teal-600 transition-all duration-300 shadow-lg shadow-emerald-500/30 hover:shadow-xl font-semibold group/btn2">
                        <svg class="w-5 h-5 group-hover/btn2:animate-bounce" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                        </svg>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="group relative bg-gradient-to-br from-white via-white/90 to-white/80 dark:from-emerald-900/30 dark:via-green-900/20 dark:to-teal-900/30 rounded-2xl border border-emerald-100/50 dark:border-emerald-700/30 overflow-hidden shadow-lg shadow-emerald-500/5 hover:shadow-2xl hover:shadow-emerald-500/20 transition-all duration-500 hover:-translate-y-2">
                        ...
                        <!-- Image Container -->
                        <div class="relative h-56 bg-gradient-to-br from-emerald-400/10 via-green-500/10 to-teal-500/10 overflow-hidden">
                            @if($product->image)
                            <img src="{{ asset('images/' . $product->image) }}" alt="{{ $product->name }}"
                                class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                            @else
                            <div class="w-full h-full flex items-center justify-center">
                                <div class="p-4 rounded-2xl bg-gradient-to-r from-emerald-400/20 via-green-500/20 to-teal-500/20">
    ...
    :root {
        ...
        --wa-emerald-500: #22c55e; /* Primary green */
        --wa-emerald-600: #16a34a; /* WhatsApp green */
        --wa-emerald-700: #15803d;
        --wa-emerald-800: #166534;
        --wa-emerald-900: #14532d;
        --wa-green-500: #25D366; /* WhatsApp logo green */
        --wa-teal-500: #0d9488; /* Accent teal */
    }
    ...
    .dark {
        ...
        --wa-emerald-500: #10b981; /* Primary green dark */
        --wa-emerald-600: #34d399; /* WhatsApp green light */
