    ...
    <div class="flex h-full w-full flex-1 flex-col gap-6 p-4 md:p-6 bg-gray-50 min-h-screen">
        ...
        <div class="hidden md:grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            ...
            <div class="group relative overflow-hidden rounded-2xl border border-gray-200 bg-white p-5 md:p-6 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                ...
                <a href="{{ route('admin.services.index') }}" class="flex items-center justify-between text-sm font-medium text-wa-dark hover:text-wa-darker transition-colors">
            ...
            <div class="group relative overflow-hidden rounded-2xl border border-gray-200 bg-white p-5 md:p-6 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                ...
                <a href="{{ route('admin.galleries.index') }}" class="flex items-center justify-between text-sm font-medium text-wa-dark hover:text-wa-darker transition-colors">
            ...
            <div class="group relative overflow-hidden rounded-2xl border border-gray-200 bg-white p-5 md:p-6 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                ...
                <a href="{{ route('admin.bookings.index') }}" class="flex items-center justify-between text-sm font-medium text-wa-dark hover:text-wa-darker transition-colors">
            ...
            <div class="group relative overflow-hidden rounded-2xl border border-gray-200 bg-white p-5 md:p-6 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                ...
                <a href="{{ route('admin.products.index') }}" class="flex items-center justify-between text-sm font-medium text-wa-dark hover:text-wa-darker transition-colors">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white overflow-hidden">
            <div class="p-5 md:p-6 border-b border-gray-100">
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mt-1">Recently added products</p>
                    </div>
                    <div class="flex gap-3">
                        <a href="{{ route('admin.products.create') }}" class="px-4 py-2.5 bg-gradient-to-r from-wa-light to-wa-dark text-white rounded-xl hover:shadow-lg transition-all flex items-center gap-2 font-medium">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                            </svg>
                            New Product
                        </a>
                        <a href="{{ route('admin.products.index') }}" class="px-4 py-2.5 border border-wa-light/30 text-wa-dark rounded-xl hover:bg-wa-light/5 transition-all flex items-center gap-2 font-medium">
                            View All
                        </a>
                    </div>
                </div>
            ...
            <div class="p-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="group bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-xl transition-all duration-300">
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                                ...
                                <a href="{{ route('admin.products.show', $product->id) }}" class="text-sm text-wa-dark hover:text-wa-darker font-medium">View →</a>
                            </div>
                        </div>
                    </div>
                    @endforeach
