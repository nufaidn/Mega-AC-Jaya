...
<head>
    ...
    <meta name="description" content="Layanan service AC profesional: Cuci AC, Isi Freon, Bongkar Pasang, Perbaikan AC. Garansi, harga transparan, teknisi berpengalaman.">
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-wa-50 rounded-2xl p-8 hover:shadow-xl transition group">
                    ...
                    <p class="text-gray-600 mb-4">Pembersihan menyeluruh indoor & outdoor unit, bebas debu & bakteri. Mengembalikan performa AC seperti baru.</p>
                ...
                <div class="bg-wa-50 rounded-2xl p-8 hover:shadow-xl transition group">
                    ...
                    <p class="text-gray-600 mb-4">Pengisian freon dengan takaran presisi menggunakan alat digital. Menggunakan freon R32/R410A/R22.</p>
                    <ul class="text-sm text-gray-600 space-y-1">
                ...
                <div class="bg-wa-50 rounded-2xl p-8 hover:shadow-xl transition group">
                    ...
                    <p class="text-gray-600 mb-4">Pindah lokasi AC atau pasang AC baru dengan rapi & aman. Termasuk pembuatan lubang & pemasangan pipa.</p>
                    <ul class="text-sm text-gray-600 space-y-1">
                ...
                <div class="bg-wa-50 rounded-2xl p-8 hover:shadow-xl transition group">
                    ...
                    <p class="text-gray-600 mb-4">Memperbaiki berbagai kerusakan AC seperti tidak dingin, berisik, atau error. Diagnosis akurat dengan alat modern.</p>
                    <ul class="text-sm text-gray-600 space-y-1">
                ...
                <div class="bg-wa-50 rounded-2xl p-8 hover:shadow-xl transition group">
                    ...
                    <p class="text-gray-600 mb-4">Paket maintenance berkala untuk menjaga performa AC tetap optimal. Hemat biaya perbaikan di masa depan.</p>
                    <ul class="text-sm text-gray-600 space-y-1">
                ...
                <div class="bg-wa-50 rounded-2xl p-8 hover:shadow-xl transition group">
                    ...
                    <p class="text-gray-600 mb-4">Pasang AC baru dari nol hingga siap pakai. Termasuk survey lokasi, pembuatan lubang, & test performa.</p>
                    <ul class="text-sm text-gray-600 space-y-1">
