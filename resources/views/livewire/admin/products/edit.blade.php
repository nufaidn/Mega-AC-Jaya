<x-layouts.app title="Edit Product">
        ...
        <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data" class="max-w-2xl">
            ...
            <div class="mb-5">
                ...
                <select name="label" id="label" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    ...
                    <option value="Promo" {{ old('label', $product->label) == 'Promo' ? 'selected' : '' }}>Promo</option>
                    <option value="Best Seller" {{ old('label', $product->label) == 'Best Seller' ? 'selected' : '' }}>Best Seller</option>
                    <option value="Flash Sale" {{ old('label', $product->label) == 'Flash Sale' ? 'selected' : '' }}>Flash Sale</option>
                    <option value="New Arrival" {{ old('label', $product->label) == 'New Arrival' ? 'selected' : '' }}>New Arrival</option>
                </select>
            </div>
            ...
            <div id="discount-fields" class="hidden">
                <div class="mb-5">
                    ...
                    <input type="number" name="original_price" id="original_price" value="{{ old('original_price', $product->original_price) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Original Price" step="0.01">
                </div>
                ...
                <div class="mb-5">
                    ...
                    <input type="number" name="discount_percentage" id="discount_percentage" value="{{ old('discount_percentage', $product->discount_percentage) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Discount Percentage" min="0" max="100">
                </div>
            </div>
            ...
            <div class="mb-5">
                ...
                @if($product->image)
                <img src="/images/{{ $product->image }}" width="300px" class="mt-2 rounded">
                @endif
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Check on page load (for existing data or old input after validation errors)
