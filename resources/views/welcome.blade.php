...
<body class="bg-wa-50 text-gray-800 antialiased">
    ...
    <!-- Hero Section -->
    <section id="home" class="hero-bg pt-20 pb-32 lg:pt-32 h-screen">
        <div class="max-w-7xl mx-auto px-6 lg:px-8 text-center">
            <div class="max-w-3xl mx-auto">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="{{ route('about') }}" class="inline-flex items-center justify-center gap-3 px-8 py-4 bg-gradient-wa text-white font-semibold rounded-xl hover:shadow-xl transition transform hover:scale-105">
